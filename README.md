...
├── hardware/
│   ├── enclosure_design/     # CAD files or measurements
│   ├── webcam_mod/           # IR filter removal guide
│   └── dvd_grating/          # DVD preparation instructions
├── software/
│   ├── spectral_extraction/  # Tracker/ImageJ scripts
│   ├── pca_analysis/         # Python Jupyter notebooks
│   └── calibration/          # Wavelength calibration code
├── data/
│   ├── raw_spectra/          # CSV files from experiments
│   └── processed/            # Normalized data for PCA
├── docs/
│   ├── calibration_protocol.md
│   ├── sample_preparation.md
│   └── pca_interpretation.md
├── results/
│   └── figures/              # Plots and validation results
└── README.md                 # You are here
⚠️ Most of these folders are currently empty and will be populated as the project progresses.
